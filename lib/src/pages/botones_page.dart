...
class BotonesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: _botonNavigationBaer(context)
    );
  }
    ...
    return SafeArea(
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(
              'Classifity transaction', 
              style: TextStyle(color: Colors.white, fontSize: 30.0, fontWeight: FontWeight.bold)
            ),
            SizedBox(height: 10.0,),
            Text(
              'Classifity this transaction info a particular category', 
  ...
  Widget _botonNavigationBaer( BuildContext context){
  ...
  Widget _botonesRedondeados() {
    return Table(
      children: [
        ...
        TableRow(
          children: [
            _crearBotonRedondeado(Colors.blueAccent, Icons.movie_filter, 'Entreteiment'),
